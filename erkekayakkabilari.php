<?php
    ...
    $ToplamKayitSayisiSorgusu = $veritabani->prepare("SELECT * FROM urunler WHERE UrunTuru = 'Erkek Ayakkabısı' AND Durumu = '1' $MenuKosulu $AramaKosulu ORDER BY id DESC");
    $ToplamKayitSayisiSorgusu->execute();
    $ToplamKayitSayisi = $ToplamKayitSayisiSorgusu->rowCount();
    $SayfalamayaBaslanacakKayitSayisi = ($Sayfalama * $SayfaBasinaGosterilecekKayitSayisi) - $SayfaBasinaGosterilecekKayitSayisi;
    $BulunanSayfaSayisi = ceil($ToplamKayitSayisi / $SayfaBasinaGosterilecekKayitSayisi);

    $AnaMenununTumUrunSayisiSorgusu = $veritabani->prepare("SELECT SUM(UrunSayisi) AS MenununToplamUrunu FROM menuler WHERE UrunTuru = 'Erkek Ayakkabısı'");
...
<div class="AnaSayfaIcerik GirisSayfasi">
    <div class="KompleSolAlan">
        <div class="AnaSayfaSolMenulerAlani">
            ...
            <ul class="AnaSayfaSolMenulerSinirlamaAlani">
                <a href="index.php?SK=83"><li class="AnaSayfaSolMenuler">Tüm Ürünler(<?php echo $AnaMenununTumUrunSayisiSorgusuKayitlari["MenununToplamUrunu"]; ?>)</li></a>
                <?php
                    $MenulerSorgusu = $veritabani->prepare("SELECT * FROM menuler WHERE UrunTuru='Erkek Ayakkabısı' ORDER BY MenuAdi ASC");
                    ...
                    foreach($MenulerSorgusuKayitlari as $Menu){
                        ...
                        ?><a style="<?php if($GelenMenuID == $Menu["id"]){ ?> color: tomato;  <?php } ?>"
                             href="index.php?SK=83&MenuID=<?php echo $Menu["id"] ?>">
    ...
    <div class="AnaSayfaUrunlerAlani">
        <div class="UrunAramaAlani">
            <form action="index.php?SK=83" method="post">
        ...
        <ul class="AnaSayfaUrunlerAlaniSinirlama">
                ...
                <?php
                $urunlerSorgusu = $veritabani->prepare("SELECT * FROM urunler WHERE UrunTuru = 'Erkek Ayakkabısı' AND Durumu = '1' $MenuKosulu $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi,$SayfaBasinaGosterilecekKayitSayisi");
                ...
                <li class="AnaSayfaUrunlerAlaniUrunKutulari">
                    ...
                    <a href="index.php?SK=82&ID=<?php $e->yazdir($Urunler["id"]); ?>">
                        <span class="UrunMetini">
                            <?php
                                $UrununAciklamaMetini = $Urunler["UrunAciklamasi"];
                                $UrununMetininiSinirlandir = mb_substr($UrununAciklamaMetini,0,25);
                                $e->yazdir($UrununMetininiSinirlandir);
                            ?>
                        </span>
                    </a>
        ...
        <div class="SayfalamaKapsamaAlani">
            <div class="SayfalamaAlaniIciNumaraAlaniKapsayicisi">
                ...
                if($Sayfalama>1){
                    $e->HTMLYazdir("<a href='index.php?SK=83{$SayfalamaKosulu}&SYF=1'><li class=\"Sayfalama\">&lt;&lt;</li></a>");
                    $SayfalamaIcinSayfaDegeriniBirGeriAl = $Sayfalama-1;
                    $e->HTMLYazdir("<a href='index.php?SK=83&{$SayfalamaKosulu}&SYF={$SayfalamaIcinSayfaDegeriniBirGeriAl}'><li class=\"Sayfalama\">&lt;</li></a>");
                }
                ...
                for($SayfalamaIcinSayfaIndexDegeri=$Sayfalama-$SayfalamaIcinSagveSolButonSayisi;$SayfalamaIcinSayfaIndexDegeri<=$Sayfalama+$SayfalamaIcinSagveSolButonSayisi;$SayfalamaIcinSayfaIndexDegeri++){
                    if($SayfalamaIcinSayfaIndexDegeri>0 and $SayfalamaIcinSayfaIndexDegeri<=$BulunanSayfaSayisi){
                        ...
                        $e->HTMLYazdir("<a href='index.php?SK=83{$SayfalamaKosulu}&SYF={$SayfalamaIcinSayfaIndexDegeri}'><li class=\"Sayfalama \">{$SayfalamaIcinSayfaIndexDegeri}</li></a>");
                        }
                    }
                }
                ...
                $e->HTMLYazdir("<a href='index.php?SK=83&{$SayfalamaKosulu}&SYF={$SayfalamaIcinSayfaDegeriniBirIleriAl}'><li class=\"Sayfalama\">&gt;</li></a>");
                $e->HTMLYazdir("<a href='index.php?SK=83{$SayfalamaKosulu}&SYF={$BulunanSayfaSayisi}'><li class=\"Sayfalama\">&gt;&gt;</li></a>");
                } ?>
                </ul>
            </div>
        </div>
