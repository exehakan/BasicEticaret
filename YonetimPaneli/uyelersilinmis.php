...
if(isset($_SESSION["Yonetici"])){
    ...
    $SayfaBasinaGosterilecekKayitSayisi = 15;
        ...
        <div class="YoneticiSayfasiSayfaIcerikleri" olay="$(this).css('border','none')">
            ...
            <div class="UyelerKapsamaAlani">
                <div class="UrunAramaAlani AramaAlaniUyelerIcerisinde">
                    <form action="index.php?SKD=0&SKI=83" method="post">
                    ...
                    if($UyelerSayisi>0){
                        foreach($UyelerKaydi as $Kayitlar){
                            ...
                            <div class="UyeninBilgilerininOlduguAlan">
                                ...
                                <a  href="index.php?SKD=0&SKI=87&ID=<?php echo $Kayitlar["id"]?>">
                                    <div class="Silinmisolanuyelerigeriac">
                                        <span>Üyeliği Tekrardan Aktifleştir</span>
                                    </div>
                                </a>
                            </div>
                    ...
                    <div class="SayfalamaKapsamaAlani">
                        <div class="SayfalamaAlaniIciNumaraAlaniKapsayicisi">
                            <ul class="SayfalamaSinirlamaAlani">
                                ...
                                if($Sayfalama>1){
                                    $e->HTMLYazdir("<a href='index.php?SKD=0&SKI=83{$SayfalamaKosulu}&SYF=1'><li class=\"Sayfalama\">&lt;&lt;</li></a>");
                                    $SayfalamaIcinSayfaDegeriniBirGeriAl = $Sayfalama-1;
                                    $e->HTMLYazdir("<a href='index.php?SKD=0&SKI=83&{$SayfalamaKosulu}&SYF={$SayfalamaIcinSayfaDegeriniBirGeriAl}'><li class=\"Sayfalama\">&lt;</li></a>");
                                }
                                ...
                                for($SayfalamaIcinSayfaIndexDegeri=$Sayfalama-$SayfalamaIcinSagveSolButonSayisi;$SayfalamaIcinSayfaIndexDegeri<=$Sayfalama+$SayfalamaIcinSagveSolButonSayisi;$SayfalamaIcinSayfaIndexDegeri++){
                                    if($SayfalamaIcinSayfaIndexDegeri>0 and $SayfalamaIcinSayfaIndexDegeri<=$BulunanSayfaSayisi){
                                        if($Sayfalama==$SayfalamaIcinSayfaIndexDegeri){
                                            ...
                                            $e->HTMLYazdir("<a href='index.php?SKD=0&SKI=83{$SayfalamaKosulu}&SYF={$SayfalamaIcinSayfaIndexDegeri}'><li class=\"Sayfalama \">{$SayfalamaIcinSayfaIndexDegeri}</li></a>");
                                        }
                                    }
                                }
                                ...
                                if($Sayfalama!=$BulunanSayfaSayisi){
                                    ...
                                    $e->HTMLYazdir("<a href='index.php?SKD=0&SKI=83&{$SayfalamaKosulu}&SYF={$SayfalamaIcinSayfaDegeriniBirIleriAl}'><li class=\"Sayfalama\">&gt;</li></a>");

                                    $e->HTMLYazdir("<a href='index.php?SKD=0&SKI=83{$SayfalamaKosulu}&SYF={$BulunanSayfaSayisi}'><li class=\"Sayfalama\">&gt;&gt;</li></a>");
                                }
                                ?>
                            </ul>
                        </div>
