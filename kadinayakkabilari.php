...
$ToplamKayitSayisiSorgusu = $veritabani->prepare("SELECT * FROM urunler WHERE UrunTuru = 'Kadın Ayakkabısı' AND Durumu = '1' $MenuKosulu $AramaKosulu ORDER BY id DESC");
$ToplamKayitSayisiSorgusu->execute();
$ToplamKayitSayisi = $ToplamKayitSayisiSorgusu->rowCount();
$SayfalamayaBaslanacakKayitSayisi = ($Sayfalama * $SayfaBasinaGosterilecekKayitSayisi) - $SayfaBasinaGosterilecekKayitSayisi;
$BulunanSayfaSayisi = ceil($ToplamKayitSayisi / $SayfaBasinaGosterilecekKayitSayisi);

$AnaMenununTumUrunSayisiSorgusu = $veritabani->prepare("SELECT SUM(UrunSayisi) AS MenununToplamUrunu FROM menuler WHERE UrunTuru = 'Kadın Ayakkabısı'");
...
<div class="AnaSayfaIcerik GirisSayfasi">
    <div class="KompleSolAlan">
        <div class="AnaSayfaSolMenulerAlani">
            ...
            <ul class="AnaSayfaSolMenulerSinirlamaAlani">
                <a href="index.php?SK=84"><li class="AnaSayfaSolMenuler">Tüm Ürünler(<?php echo $AnaMenununTumUrunSayisiSorgusuKayitlari["MenununToplamUrunu"]; ?>)</li></a>
                <?php
                $MenulerSorgusu = $veritabani->prepare("SELECT * FROM menuler WHERE UrunTuru='Kadın Ayakkabısı' ORDER BY MenuAdi ASC");
                ...
                foreach($MenulerSorgusuKayitlari as $Menu){
                    ...
                    ?><a style="<?php if($GelenMenuID == $Menu["id"]){ ?> color: tomato;  <?php } ?>"
                         href="index.php?SK=84&MenuID=<?php echo $Menu["id"] ?>">
    ...
    <div class="AnaSayfaUrunlerAlani">
        ...
        <ul class="AnaSayfaUrunlerAlaniSinirlama">
            ...
            <?php
            $urunlerSorgusu = $veritabani->prepare("SELECT * FROM urunler WHERE UrunTuru = 'Kadın Ayakkabısı' AND Durumu = '1' $MenuKosulu $AramaKosulu ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi,$SayfaBasinaGosterilecekKayitSayisi");
            ...
            <div class="SayfalamaKapsamaAlani">
                <div class="SayfalamaAlaniIciNumaraAlaniKapsayicisi">
                    <ul class="SayfalamaSinirlamaAlani">
                        ...
                        if($Sayfalama>1){
                            $e->HTMLYazdir("<a href='index.php?SK=84{$SayfalamaKosulu}&SYF=1'><li class=\"Sayfalama\">&lt;&lt;</li></a>");
                            $SayfalamaIcinSayfaDegeriniBirGeriAl = $Sayfalama-1;
                            $e->HTMLYazdir("<a href='index.php?SK=84&{$SayfalamaKosulu}&SYF={$SayfalamaIcinSayfaDegeriniBirGeriAl}'><li class=\"Sayfalama\">&lt;</li></a>");
                        }
                        ...
                        for($SayfalamaIcinSayfaIndexDegeri=$Sayfalama-$SayfalamaIcinSagveSolButonSayisi;$SayfalamaIcinSayfaIndexDegeri<=$Sayfalama+$SayfalamaIcinSagveSolButonSayisi;$SayfalamaIcinSayfaIndexDegeri++){
                            if($SayfalamaIcinSayfaIndexDegeri>0 and $SayfalamaIcinSayfaIndexDegeri<=$BulunanSayfaSayisi){
                                if($Sayfalama==$SayfalamaIcinSayfaIndexDegeri){
                                    ...
                                    $e->HTMLYazdir("<a href='index.php?SK=84{$SayfalamaKosulu}&SYF={$SayfalamaIcinSayfaIndexDegeri}'><li class=\"Sayfalama \">{$SayfalamaIcinSayfaIndexDegeri}</li></a>");
                                }
                            }
                        }
                        ...
                        if($Sayfalama!=$BulunanSayfaSayisi){
                            ...
                            $e->HTMLYazdir("<a href='index.php?SK=84&{$SayfalamaKosulu}&SYF={$SayfalamaIcinSayfaDegeriniBirIleriAl}'><li class=\"Sayfalama\">&gt;</li></a>");


                            $e->HTMLYazdir("<a href='index.php?SK=84{$SayfalamaKosulu}&SYF={$BulunanSayfaSayisi}'><li class=\"Sayfalama\">&gt;&gt;</li></a>");
